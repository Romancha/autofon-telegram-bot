...
* Отправка уведомление в Телеграм с информацией о новом состоянии, включая:
    ...
    * Текущеее местоположение устройства и точность определения
...
Для добавления устройства в список отслеживаний, нажмите на кнопку "Настройка отслеживания" в боте.
